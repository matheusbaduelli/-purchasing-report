...
cursor.execute("""
    SELECT 
        ...
        lista_tecnica.CódigodoProduto,
        lista_tecnica.DescriçãodoProduto,
        lista_tecnica.CódigoN1,
        lista_tecnica.DescricaoN1,
        lista_tecnica.Qtd,
        lista_tecnica.CódigoN2,
        lista_tecnica.DescricaoN2,
        lista_tecnica.Qtd1,
        lista_tecnica.CódigoN3,
        lista_tecnica.DescricaoN3,
        lista_tecnica.Qtd2,
        lista_tecnica.CódigoN4,
        lista_tecnica.DescricaoN4,
        lista_tecnica.Qt3,
        lista_tecnica.Somase,
        lista_tecnica.Somase1,
        lista_tecnica.Somase2,
        lista_de_pedidos.Qtd
    FROM 
        lista_de_pedidos 
    INNER JOIN 
        lista_tecnica 
    ON 
        lista_de_pedidos.Codigo = lista_tecnica.CódigodoProduto
""")
...
for linha in cursor.fetchall():
    lista = {
        ...
        "Qtd1": linha[8],
        "CódigoN3": linha[9],
        "DescricaoN3": linha[10],
        "Qtd2": linha[11],
        "CódigoN4": linha[12],
        "DescricaoN4": linha[13],
        "Qtd3": linha[14],
        "SomaSe": linha[15],
        "SomaSe1": linha[16],
        "SomaSe2": linha[17],
        "QtdPedido": linha[18],
        "QtdMultiSomase": (linha[15] or 0) * (linha[18] or 0),
